...
const translations: Translations = {
  ...
  saas_desc: {
    en: "A multi-tenant AI SaaS I built end-to-end. Teams create conversational agents with custom tools, RAG knowledge bases (OpenAI + Google embeddings, vector search) and bulk campaigns, then connect them to WhatsApp, Instagram, LinkedIn, Telegram and Twitter via Unipile — or embed them as a chat widget. Fastify v5 backend with Drizzle + Supabase + Upstash Redis, LangChain orchestrating Claude, GPT and Gemini, RBAC, platform API keys and a token/cost usage dashboard.",
    es: "Un SaaS de IA multi-tenant que construí de punta a punta. Los equipos crean agentes conversacionales con tools propias, bases de conocimiento RAG (embeddings de OpenAI + Google, búsqueda vectorial) y campañas masivas, y los conectan a WhatsApp, Instagram, LinkedIn, Telegram y Twitter vía Unipile — o los embeben como chat widget. Backend en Fastify v5 con Drizzle + Supabase + Upstash Redis, LangChain orquestando Claude, GPT y Gemini, RBAC, API keys de plataforma y dashboard de uso por tokens y costo.",
  },
  tuplaza_desc: {
